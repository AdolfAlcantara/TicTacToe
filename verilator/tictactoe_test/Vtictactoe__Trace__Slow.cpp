...
void Vtictactoe::traceInitThis__1(Vtictactoe__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->declBus  (c+30,"tictactoe hcount",-1,10,0);
	vcdp->declBus  (c+31,"tictactoe vcount",-1,9,0);
	vcdp->declBus  (c+32,"tictactoe board_address",-1,18,0);
	vcdp->declBus  (c+33,"tictactoe sign_address",-1,14,0);
	vcdp->declBus  (c+34,"tictactoe win_address",-1,14,0);
	vcdp->declBus  (c+35,"tictactoe won_address",-1,16,0);
	vcdp->declBus  (c+36,"tictactoe won_word",-1,16,0);
	{int i; for (i=0; i<16; i++) {
		vcdp->declBus  (c+13+i*1,"tictactoe board",(i+0),1,0);}}
	{int i; for (i=0; i<9; i++) {
		vcdp->declBus  (c+37+i*1,"tictactoe board_record",(i+0),14,0);}}
	vcdp->declBus  (c+46,"tictactoe flip_ram",-1,3,0);
	vcdp->declBit  (c+58,"tictactoe flip",-1);
	vcdp->declBus  (c+47,"tictactoe selector",-1,1,0);
	...
	vcdp->declBit  (c+29,"tictactoe won_condition",-1);
	vcdp->declBus  (c+50,"tictactoe winner",-1,1,0);
	vcdp->declBit  (c+48,"tictactoe draw",-1);
	vcdp->declBus  (c+49,"tictactoe unnamedblk1 i",-1,31,0);
	vcdp->declBus  (c+32,"tictactoe data address",-1,18,0);
	...
	vcdp->declBus  (c+33,"tictactoe data2 address",-1,14,0);
	vcdp->declBus  (c+47,"tictactoe data2 selector",-1,1,0);
	...
	vcdp->declBus  (c+33,"tictactoe data2 dat address",-1,14,0);
	...
	vcdp->declBus  (c+33,"tictactoe data2 dat2 address",-1,14,0);
	...
	vcdp->declBus  (c+35,"tictactoe data3 address",-1,16,0);
...
void Vtictactoe::traceFullThis__1(Vtictactoe__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->fullBus  (c+13,(vlTOPp->tictactoe__DOT__board[0]),2);
	vcdp->fullBus  (c+14,(vlTOPp->tictactoe__DOT__board[1]),2);
	vcdp->fullBus  (c+15,(vlTOPp->tictactoe__DOT__board[2]),2);
	vcdp->fullBus  (c+16,(vlTOPp->tictactoe__DOT__board[3]),2);
	vcdp->fullBus  (c+17,(vlTOPp->tictactoe__DOT__board[4]),2);
	vcdp->fullBus  (c+18,(vlTOPp->tictactoe__DOT__board[5]),2);
	vcdp->fullBus  (c+19,(vlTOPp->tictactoe__DOT__board[6]),2);
	vcdp->fullBus  (c+20,(vlTOPp->tictactoe__DOT__board[7]),2);
	vcdp->fullBus  (c+21,(vlTOPp->tictactoe__DOT__board[8]),2);
	vcdp->fullBus  (c+22,(vlTOPp->tictactoe__DOT__board[9]),2);
	vcdp->fullBus  (c+23,(vlTOPp->tictactoe__DOT__board[10]),2);
	vcdp->fullBus  (c+24,(vlTOPp->tictactoe__DOT__board[11]),2);
	vcdp->fullBus  (c+25,(vlTOPp->tictactoe__DOT__board[12]),2);
	vcdp->fullBus  (c+26,(vlTOPp->tictactoe__DOT__board[13]),2);
	vcdp->fullBus  (c+27,(vlTOPp->tictactoe__DOT__board[14]),2);
	vcdp->fullBus  (c+28,(vlTOPp->tictactoe__DOT__board[15]),2);
	vcdp->fullBit  (c+29,(vlTOPp->tictactoe__DOT__won_condition));
	vcdp->fullBus  (c+30,(vlTOPp->tictactoe__DOT__hcount),11);
	vcdp->fullBus  (c+31,(vlTOPp->tictactoe__DOT__vcount),10);
	vcdp->fullBus  (c+32,(vlTOPp->tictactoe__DOT__board_address),19);
	vcdp->fullBus  (c+33,(vlTOPp->tictactoe__DOT__sign_address),15);
	vcdp->fullBus  (c+34,(vlTOPp->tictactoe__DOT__win_address),15);
	vcdp->fullBus  (c+35,(vlTOPp->tictactoe__DOT__won_address),17);
	vcdp->fullBus  (c+36,(vlTOPp->tictactoe__DOT__won_word),17);
	vcdp->fullBus  (c+37,(vlTOPp->tictactoe__DOT__board_record[0]),15);
	vcdp->fullBus  (c+38,(vlTOPp->tictactoe__DOT__board_record[1]),15);
	vcdp->fullBus  (c+39,(vlTOPp->tictactoe__DOT__board_record[2]),15);
	vcdp->fullBus  (c+40,(vlTOPp->tictactoe__DOT__board_record[3]),15);
	vcdp->fullBus  (c+41,(vlTOPp->tictactoe__DOT__board_record[4]),15);
	vcdp->fullBus  (c+42,(vlTOPp->tictactoe__DOT__board_record[5]),15);
	vcdp->fullBus  (c+43,(vlTOPp->tictactoe__DOT__board_record[6]),15);
	vcdp->fullBus  (c+44,(vlTOPp->tictactoe__DOT__board_record[7]),15);
	vcdp->fullBus  (c+45,(vlTOPp->tictactoe__DOT__board_record[8]),15);
	vcdp->fullBus  (c+46,(vlTOPp->tictactoe__DOT__flip_ram),4);
	vcdp->fullBus  (c+47,(vlTOPp->tictactoe__DOT__selector),2);
	vcdp->fullBit  (c+48,(vlTOPp->tictactoe__DOT__draw));
